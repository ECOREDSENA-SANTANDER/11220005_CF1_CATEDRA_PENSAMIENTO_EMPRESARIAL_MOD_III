...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-8.col-11
        ImagenInfografica.color-secundario.mb-2
          ...
          .tarjeta.color-acento-botones.p-3(x="79%" y="6%" numero="1")
            h5.mb-2 1. Producto o servicio que se ofrecerá para satisfacer las necesidades del mercado.

          .tarjeta.color-acento-botones.p-3(x="95%" y="85%" numero="2")
            h5.mb-2 2. Actividades empresariales que realizará directamente y cuáles serán subcontratadas.

          .tarjeta.color-acento-botones.p-3(x="63%" y="85%" numero="3")
    ...
    .titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 3.1  Seguimiento, revisión, registro e informe
        ...
        PasosA.color-acento-contenido.mb-5(tipo="n")
          .row.justify-content-center
            .col-md-7.mb-4.mb-md-0
              h3 Escuchar al personal
              p Sin asumir que siempre tiene la verdad absoluta.
            .col-md-5
              figure
                img(src='@/assets/curso/temas/t3/img04.png', alt='Texto que describa la imagen')


          .row.justify-content-center
            .col-md-5.mb-4.mb-md-0
              figure
                img(src='@/assets/curso/temas/t3/img05.png', alt='Texto que describa la imagen')
     
            .col-md-7
              h3 Mantener al equipo informado
              p Estableciendo canales de comunicación claros y fluidos en ambas direcciones.
              

          .row
            .col-md-7.mb-4.mb-md-0
              h3 Desarrollar planes de motivación y formación
              p Adaptados a las necesidades individuales de los colaboradores.
          
            .col-md-5
              figure
                img(src='@/assets/curso/temas/t3/img06.png', alt='Texto que describa la imagen')
          
          .row
            .col-md-5.mb-4.mb-md-0
              figure
                img(src='@/assets/curso/temas/t3/img07.png', alt='Texto que describa la imagen')
    ...
    Separador
    .titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 3.2  La gerencia del mercadeo
    
    p En el entorno competitivo actual, las empresas deben centrarse en el mercado y en el cliente, más que en las ventas o el producto. Este enfoque requiere cambios significativos en:
    
    .row.justify-content-center.align-items-center.mb-5(data-aos="flip-up")
      .col-lg-12
        img.mb-3(src='@/assets/curso/temas/t3/img09.svg', alt='Texto que describa la imagen')
    
        p Para que los directores de mercadeo alcancen sus objetivos, es necesario contar con un buen plan y una estructura organizacional adecuada. Mientras que en empresas pequeñas una sola persona puede realizar tareas como investigación, ventas, publicidad y servicios, en empresas grandes se requiere un equipo especializado, por lo tanto, es necesaria la implementación de actividades clave al interior del departamento de mercadeo, entre ellas están las siguientes:
        ol.lista-ol--cuadro
          li
          .lista-ol--cuadro__vineta
            span 1
    ...
    .row.mb-2(data-aos='fade')
      ...
      .col-lg-7.ps-lg-0
        .br-l.bg1.p-4.h-100.d-flex.align-items-center.mont1
          p Todos los niveles que integran el negocio deberían interactuar armoniosamente con el fin de conseguir los objetivos generales de la empresa. Muchas veces, en la práctica, las relaciones interdepartamentales se caracterizan por presentar grandes rivalidades; estos conflictos, en ocasiones, surgen como consecuencia de las diferencias de opinión sobre lo que es mejor para los intereses de la empresa. <br><br>En una empresa, cada departamento tiene su impacto potencial en la satisfacción de requerimientos por parte del consumidor, a través de sus actividades y decisiones. Bajo el concepto de mercadeo, todos los departamentos necesitan pensar en el cliente y trabajar conjuntamente para satisfacer sus necesidades y expectativas. 
      .py-2
      p El director de mercadeo tiene dos responsabilidades principales:
      ol.lista-ol--cuadro
          li
          .lista-ol--cuadro__vineta
            span 1
          |Coordinar las actividades de mercadeo interno de la empresa. 
          li
          .lista-ol--cuadro__vineta
            span 2
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos='fade')
      .col-lg-12
        p La publicidad es una herramienta de promoción de las ideas, bienes o servicios, que debe tener una importante participación dentro de los departamentos de mercadeo de las empresas.
        p En el desarrollo de un programa de publicidad, los directores de mercadeo deben comenzar siempre por la identificación del público objetivo y de sus motivos de compra, luego establecer los objetivos de mercado, el presupuesto, el mensaje que se quiere transmitir, los medios a utilizar y los resultados a medir.
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos='fade')
      ...
      .col-lg-8
        ...
        ul.lista-ul--color
          ...
          li
            i.fas.fa-angle-right
            |Cuando los detallistas tienen mayor influencia, los directores asignan menos presupuesto a publicidad que a promociones.
